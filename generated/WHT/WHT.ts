...
export class WHT__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class WHT extends ethereum.SmartContract {
  static bind(address: Address): WHT {
    return new WHT("WHT", address);
  }
  ...
  _setRiskControl(_address: Address): BigInt {
    let result = super.call(
      "_setRiskControl",
      "_setRiskControl(address):(uint256)",
  ...
  try__setRiskControl(_address: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_setRiskControl",
      "_setRiskControl(address):(uint256)",
      [ethereum.Value.fromAddress(_address)]
  ...
  _setBorrowFeeFactorMantissa(_borrowFee: BigInt): BigInt {
    let result = super.call(
      "_setBorrowFeeFactorMantissa",
      "_setBorrowFeeFactorMantissa(uint256):(uint256)",
  ...
  try__setBorrowFeeFactorMantissa(
    _borrowFee: BigInt
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_setBorrowFeeFactorMantissa",
  ...
  _setRedeemFeeFactorMantissa(_redeemFee: BigInt): BigInt {
    let result = super.call(
      "_setRedeemFeeFactorMantissa",
      "_setRedeemFeeFactorMantissa(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(_redeemFee)]
    );

    return result[0].toBigInt();
  }

  try__setRedeemFeeFactorMantissa(
    _redeemFee: BigInt
  ): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_setRedeemFeeFactorMantissa",
  ...
  _setFeeManager(_feeManager: Address): BigInt {
    let result = super.call(
      "_setFeeManager",
      "_setFeeManager(address):(uint256)",
      [ethereum.Value.fromAddress(_feeManager)]
    );

    return result[0].toBigInt();
  }

  try__setFeeManager(_feeManager: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "_setFeeManager",
      "_setFeeManager(address):(uint256)",
      [ethereum.Value.fromAddress(_feeManager)]
  ...
  getAccountSnapshot(account: Address): WHT__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new WHT__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<WHT__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new WHT__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  riskControl(): Address {
    let result = super.call("riskControl", "riskControl():(address)", []);

    return result[0].toAddress();
  }

  try_riskControl(): ethereum.CallResult<Address> {
    let result = super.tryCall("riskControl", "riskControl():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
...
export class _setRiskControlCall extends ethereum.Call {
  get inputs(): _setRiskControlCall__Inputs {
    return new _setRiskControlCall__Inputs(this);
  }

  get outputs(): _setRiskControlCall__Outputs {
    return new _setRiskControlCall__Outputs(this);
  }
}

export class _setRiskControlCall__Inputs {
  _call: _setRiskControlCall;

  constructor(call: _setRiskControlCall) {
    this._call = call;
  }
...
export class _setRiskControlCall__Outputs {
  _call: _setRiskControlCall;
...
export class _setBorrowFeeFactorMantissaCall extends ethereum.Call {
  get inputs(): _setBorrowFeeFactorMantissaCall__Inputs {
    return new _setBorrowFeeFactorMantissaCall__Inputs(this);
  }

  get outputs(): _setBorrowFeeFactorMantissaCall__Outputs {
    return new _setBorrowFeeFactorMantissaCall__Outputs(this);
  }
}

export class _setBorrowFeeFactorMantissaCall__Inputs {
  _call: _setBorrowFeeFactorMantissaCall;

  constructor(call: _setBorrowFeeFactorMantissaCall) {
    this._call = call;
  }
...
export class _setBorrowFeeFactorMantissaCall__Outputs {
  _call: _setBorrowFeeFactorMantissaCall;
...
export class _setRedeemFeeFactorMantissaCall extends ethereum.Call {
  get inputs(): _setRedeemFeeFactorMantissaCall__Inputs {
    return new _setRedeemFeeFactorMantissaCall__Inputs(this);
  }

  get outputs(): _setRedeemFeeFactorMantissaCall__Outputs {
    return new _setRedeemFeeFactorMantissaCall__Outputs(this);
  }
}

export class _setRedeemFeeFactorMantissaCall__Inputs {
  _call: _setRedeemFeeFactorMantissaCall;

  constructor(call: _setRedeemFeeFactorMantissaCall) {
    this._call = call;
  }
...
export class _setRedeemFeeFactorMantissaCall__Outputs {
  _call: _setRedeemFeeFactorMantissaCall;
...
export class _setFeeManagerCall extends ethereum.Call {
  get inputs(): _setFeeManagerCall__Inputs {
    return new _setFeeManagerCall__Inputs(this);
  }

  get outputs(): _setFeeManagerCall__Outputs {
    return new _setFeeManagerCall__Outputs(this);
  }
}

export class _setFeeManagerCall__Inputs {
  _call: _setFeeManagerCall;

  constructor(call: _setFeeManagerCall) {
    this._call = call;
  }
...
export class _setFeeManagerCall__Outputs {
  _call: _setFeeManagerCall;
